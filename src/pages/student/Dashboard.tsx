  ...
  return (
    <MainLayout>
      ...
      <div className="mb-4 animate-fade-in">
        <div className="bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-600 rounded-2xl p-4 sm:p-6 shadow-2xl transform hover:scale-102 transition-all duration-500 animate-gradient-x">
      ...
      <div className="space-y-4 pb-16 md:pb-0">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-4 animate-slide-in-right">
          <div className="md:col-span-2 space-y-3 md:space-y-4">
            {/* Stats */}
            <DashboardStats stats={stats} userType="student" />
          </div>
          
          <div className="md:col-span-1 transform hover:scale-105 transition-all duration-300">
            <DailyCoinsCard />
          </div>
        </div>
        
        {/* Badges Section with Emojis */}
        <div className="bg-gradient-to-br from-violet-600 via-purple-600 to-indigo-600 rounded-2xl p-4 shadow-2xl text-white transform hover:scale-102 transition-all duration-500 animate-fade-in">
          ...
          <div className="flex flex-wrap gap-2 md:gap-3">
            {badges.bronze > 0 && (
              <Badge className="bg-gradient-to-r from-amber-500 to-orange-500 text-white px-3 py-2 shadow-lg hover:scale-110 transition-all duration-300 animate-pulse">
            ...
            {badges.silver > 0 && (
              <Badge className="bg-gradient-to-r from-gray-400 to-gray-500 text-white px-3 py-2 shadow-lg hover:scale-110 transition-all duration-300 animate-pulse">
                <span className="text-lg mr-1">🥈</span>
                <Award className="h-4 w-4 mr-1" /> 
            ...
            {badges.gold > 0 && (
              <Badge className="bg-gradient-to-r from-yellow-400 to-yellow-600 text-white px-3 py-2 shadow-lg hover:scale-110 transition-all duration-300 animate-pulse">
                <span className="text-lg mr-1">🥇</span>
                <Award className="h-4 w-4 mr-1" /> 
                {badges.gold} Gold
              </Badge>
            ...
            {badges.bronze === 0 && badges.silver === 0 && badges.gold === 0 && (
              <div className="flex items-center text-white/90 animate-bounce">
        ...
        <div className="bg-gradient-to-br from-emerald-500 via-teal-500 to-cyan-600 rounded-2xl p-4 shadow-2xl text-white transform hover:scale-102 transition-all duration-500 animate-fade-in">
          ...
          <div className="grid grid-cols-2 gap-3">
            <Link 
              to="/classes"
              className="flex flex-col items-center p-3 md:p-4 bg-white/20 backdrop-blur-sm rounded-xl shadow-lg hover:bg-white/30 hover:scale-105 transition-all duration-300 group"
            >
              <div className="text-2xl mb-2 group-hover:animate-bounce">📚</div>
              <BookOpen className="h-6 w-6 md:h-8 md:w-8 text-white mb-2 group-hover:animate-pulse" />
            ...
            >
              <div className="text-2xl mb-2 group-hover:animate-bounce">🧠</div>
              <Award className="h-6 w-6 md:h-8 md:w-8 text-white mb-2 group-hover:animate-pulse" />
        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden border-0 transform hover:scale-102 transition-all duration-500 animate-fade-in">
          <div className="bg-gradient-to-r from-indigo-600 to-purple-600 p-3 md:p-4">
            <div className="flex justify-between items-center">
              ...
              <Button asChild variant="secondary" size="sm" className="bg-white/20 hover:bg-white/30 text-white hover:scale-105 transition-all duration-300">
          ...
          <div className="p-3 md:p-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 md:gap-4">
              ...
              {recentQuizzes.length === 0 && (
                <div className="col-span-2 text-center py-6 text-gray-500 animate-bounce">
          ...
          <div className="p-3 md:p-4">
            <div className="grid gap-3 md:gap-4">
              {upcomingExams.slice(0, 1).map((exam, index) => (
                <div key={exam.id} className="animate-fade-in" style={{ animationDelay: `${index * 100}ms` }}>
                  <ExamCard exam={exam} />
                </div>
              ))}
              {upcomingExams.length === 0 && (
                <div className="text-center py-6 text-gray-500 animate-bounce">
                  <span className="text-4xl block mb-2">📅</span>
          ...
          <div className="bg-gradient-to-r from-green-500 to-emerald-500 p-3 md:p-4">
            <div className="flex justify-between items-center flex-wrap gap-2">
              ...
              <div className="flex items-center gap-2">
                ...
                <Button asChild variant="secondary" size="sm" className="bg-white/20 hover:bg-white/30 text-white hover:scale-105 transition-all duration-300 h-8">
          ...
          <div className="p-3 md:p-4">
            ...
            >
              ...
              <div className="flex justify-center mt-4 gap-2">
                <CarouselPrevious className="static translate-y-0 h-8 w-8 hover:scale-110 transition-all duration-300" />
                <CarouselNext className="static translate-y-0 h-8 w-8 hover:scale-110 transition-all duration-300" />
              </div>
            </Carousel>

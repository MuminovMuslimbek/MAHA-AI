...
import { Book, LogIn, Sparkles } from 'lucide-react';
      ...
      <div className="w-full max-w-md animate-fade-in">
        <Card className="w-full backdrop-blur-sm bg-white/90 border-0 shadow-2xl transform hover:scale-102 transition-all duration-500">
          <CardHeader className="space-y-3 text-center">
            ...
            <CardDescription className="text-center font-medium p-4 bg-gradient-to-r from-purple-100 to-blue-100 rounded-xl border border-purple-200">
              <div className="text-quiz-purple mb-2 flex items-center justify-center">
          ...
          <form onSubmit={handleSubmit}>
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <Link
                    to="/forgot-password"
                    className="text-sm text-quiz-purple hover:underline flex items-center transition-all duration-300 hover:scale-105"
                  >
            ...
            <CardFooter className="flex flex-col space-y-4">
              <Button
                type="submit"
                className="w-full bg-gradient-to-r from-quiz-purple via-blue-500 to-indigo-600 hover:from-quiz-purple-dark hover:via-blue-600 hover:to-indigo-700 transition-all duration-500 shadow-xl hover:shadow-2xl text-lg py-3 rounded-xl font-semibold hover:scale-105"
                disabled={isLoading}
              >
                {isLoading ? (
              ...
              <p className="text-center text-sm text-gray-600">
                ...
                <Link to="/register" className="text-quiz-purple font-semibold hover:underline transition-all duration-300 hover:scale-105 inline-flex items-center">
                  <span className="mr-1">✨</span>
                  Sign up
                </Link>
              </p>
